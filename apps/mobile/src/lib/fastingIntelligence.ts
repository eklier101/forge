/**
 * Client-side mirrors of fasting intelligence heuristics (offline / display).
 * Server is source of truth for insights API; keep formulas aligned.
 */
...
export function suggestedEndWindow(history: FastHistoryRow[]): {
  ...
  return {
    fromLabel: formatLocalTimeLabel(med - 45),
    toLabel: formatLocalTimeLabel(med + 45),
...
export const BREAK_REASON_OPTIONS: { id: FastBreakReason; label: string }[] = [
